...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      //Check if profile field doesnt exist -> make it empty string
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="If you want your latest repos and a Gthub link, inlcude your username"
                />
                <TextAreaFieldGroup
                ...
                <div className="mb-3">
                  <button
                    ...
                    type="button" //Don't want it submitting! so give it a type
